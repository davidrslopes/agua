...
function custom_gallery_grid($output = '', $attrs, $instance) {
  ...
  foreach ($images as $imageID) {
	...
	$captions .= '<article style="display: none;" class="wp-caption-text gallery-caption" id="' . $caption_id . '"><div class="row"><div class="col-'.$col.' offset-'. ( $x * $col - $col ) .' '.$all_align.'"><img src="'.get_template_directory_uri().'/img/Linha-gotas-brancas.png" alt="Gotas" ></div></div><div class="row"><div class=" teste col-12 col-md-'.$caption_col.' '.$all_align2.'"><p>' . $galleryThumbCap . '</p></div></div></article>';
	$x++;
  }
