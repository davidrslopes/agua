...
<section class="fastio-images-hero fastio-hotwheels-subpages-1">
        ...
        <div class="container-fluid">
           <div class="row">    
            ...
            <div class="col-12 <?php if(!wp_is_mobile()){echo "offset-2";}?> col-lg-3" style="position: relative;z-index:10;">           
                <div data-aos="fade-up" data-aos-duration="3000">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6 manchagarrafa" style="margin-top:-9rem;position: relative;z-index:0;padding-right: 0px;">
                    <div data-aos="fade-up" data-aos-duration="3000">
